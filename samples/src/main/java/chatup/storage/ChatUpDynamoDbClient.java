...
public class ChatUpDynamoDbClient {
    private final AmazonDynamoDBClient dynamoDBClient;

    public ChatUpDynamoDbClient(final AmazonDynamoDBClient dynamoDBClient) {
     ...
     * @return
     */
    public ChatUpDynamoDataItem loadItem(final ChatUpDynamoDataItem tableItem) {
        DynamoDBMapper mapper = createDynamoDBMapper();
        ChatUpDynamoDataItem item = mapper.load(tableItem);
        return item;
    }
     ...
     * @param tableItem
     */
    public void saveItem(final ChatUpDynamoDataItem tableItem) {
        DynamoDBMapper mapper = createDynamoDBMapper();
